        ...
        <AnimatePresence>
          {open && (
            ...
            <motion.div
              ...
              className="fixed inset-0 bg-surface-ground/80 backdrop-blur-sm"
              aria-hidden="true"
            />
            ...
            <motion.div
              ...
              className={cn(
                ...
                "bg-surface-2 border border-border-strong shadow-2xl flex flex-col"
              )}
            >
              {/* Search input header */}
              ...
              {/* Category tabs */}
              <div className="flex items-center gap-1 px-4 py-2 border-b border-border-subtle bg-surface-1/50 text-xs">
                    ...
                    return (
                      <Link
                        ...
                        className={cn(
                          ...
                          isSelected ? "bg-brand-500/15 text-brand-300" : "hover:bg-surface-3/60 text-text-primary"
                        )}
                      >
