...
function FeatureCard({ title, description, icon, badge, index }: FeatureCardProps) {
 return (
  <motion.div
   ...
   className="p-7 sm:p-8 rounded-3xl bg-surface-1 border border-border-subtle hover:border-brand-500/50 transition-all duration-300 shadow-xl group flex flex-col justify-between"
  >
   <div className="space-y-4">
    <div className="flex items-center justify-between">
     <div className="p-3.5 rounded-2xl bg-brand-500/15 border border-brand-500/30 text-brand-300 group-hover:scale-110 group-hover:bg-brand-500 group-hover:text-primary-foreground transition-all duration-300">
      {icon}
     </div>
