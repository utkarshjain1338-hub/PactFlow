    ...
    <section className="relative min-h-screen flex flex-col justify-center items-center overflow-hidden pt-28 pb-20 px-4 sm:px-6 lg:px-8 bg-surface-0">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center space-y-8 my-auto">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-surface-1/90 border border-brand-500/30 shadow-brand-xs backdrop-blur-md"
        >
        ...
        >
          ...
          <Link href="/escrows" className="w-full sm:w-auto">
            <Button
              ...
              className="w-full sm:w-auto px-7 py-4 text-base font-semibold bg-surface-1/80 hover:bg-surface-2 transition-all border-border-default"
            >
        ...
        >
          ...
          <div className="relative flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 p-6 sm:p-8 rounded-3xl bg-surface-1/70 border border-border-subtle backdrop-blur-xl shadow-2xl">
            {/* Client Node */}
