   ...
   <div className="max-w-6xl mx-auto space-y-20 relative z-10">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
     ...
     <motion.div
      ...
      className="p-8 rounded-3xl bg-surface-1 border border-cyan-500/30 shadow-2xl relative overflow-hidden space-y-6 flex flex-col justify-between"
     >
     ...
     <motion.div
      ...
      whileHover={{ scale: 1.02, y: -4 }}
      className="p-8 rounded-3xl bg-surface-1 border border-brand-500/30 shadow-2xl relative overflow-hidden space-y-6 flex flex-col justify-between"
     >
      <div className="space-y-3">
     ...
     <motion.div
      ...
      whileHover={{ scale: 1.02, y: -4 }}
      className="p-8 rounded-3xl bg-surface-1 border border-status-success/30 shadow-2xl relative overflow-hidden space-y-6 flex flex-col justify-between"
     >
      <div className="space-y-3">
