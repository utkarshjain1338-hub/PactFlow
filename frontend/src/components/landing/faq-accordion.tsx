...
function FAQItem({ question, answer, badge, isOpen, onToggle }: FAQItemProps) {
 return (
  <div className="border border-border-subtle rounded-2xl bg-surface-1 overflow-hidden transition-colors hover:border-border-default">
   <button
    onClick={onToggle}
...
export function FAQAccordion() {
 ...
 return (
  <section id="faq" className="py-28 px-4 sm:px-6 lg:px-8 bg-surface-1 border-t border-border-subtle relative">
