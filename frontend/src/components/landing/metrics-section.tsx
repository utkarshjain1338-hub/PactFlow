...
function MetricCounter({ label, valueString, subValue, icon, delay = 0 }: MetricCounterProps) {
  ...
  return (
    <motion.div
      ...
      className="p-8 rounded-3xl bg-surface-1/90 border border-border-subtle hover:border-brand-500/40 transition-all shadow-xl backdrop-blur-xl flex flex-col justify-between space-y-4 text-center group"
    >
