...
export function TestimonialsSection() {
 ...
 return (
  <section className="py-28 px-4 sm:px-6 lg:px-8 bg-surface-1 border-t border-border-subtle relative overflow-hidden">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
     {testimonials.map((t, idx) => (
      <motion.div
       ...
       className="p-8 rounded-3xl bg-surface-0 border border-border-subtle hover:border-brand-500/40 transition-all shadow-xl flex flex-col justify-between space-y-6 group"
      >
