  ...
  return (
    <DashboardShell title="Projects" breadcrumbs={[{ label: "Projects" }]}>
      ...
      <div className="space-y-6">
        {/* Filter & Search Bar */}
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 rounded-2xl bg-surface-1/90 border border-border-subtle backdrop-blur-md">
          {/* Category Tabs */}
